...
origin_attribute = {
    ...
    'base':          {'unit_type':BASE,    'origin_max_health':7500,    'origin_max_speed':0, 'origin_shot_range':11,'origin_defense':50, 'defense_type':FORT,      'origin_attack':25, 'attack_type':ARTILLERY, 'skill_cd_1':1,'skill_cd_2':-1,    'max_account':0,   'people_cost':0, 'money_cost':0,   'tech_cost':0   },
    ...
    'hacker':        {'unit_type':INFANTRY,'origin_max_health':300,      'origin_max_speed':4, 'origin_shot_range':15,'origin_defense':20, 'defense_type':UNARMORED,'origin_attack':0, 'attack_type':NULL, 'skill_cd_1':1,   'skill_cd_2':-1, 'max_account':200,'people_cost':2, 'money_cost':500, 'tech_cost':250 },
    'superman':      {'unit_type':INFANTRY,'origin_max_health':500,      'origin_max_speed':5, 'origin_shot_range':10,'origin_defense':150,'defense_type':MEDIUM,   'origin_attack':15,'attack_type':ELEC, 'skill_cd_1':1,   'skill_cd_2':50,   'max_account':1,   'people_cost':5,'money_cost':2000,'tech_cost':1200},
    ...
    'bolt_tank':     {'unit_type':VEHICLE, 'origin_max_health':500,      'origin_max_speed':9, 'origin_shot_range':14,'origin_defense':100,'defense_type':LIGHT,   'origin_attack':200,'attack_type':ELEC,'skill_cd_1':10,  'skill_cd_2':-1, 'max_account':200,'people_cost':3, 'money_cost':800,'tech_cost':350 },
    ...
    'uav':           {'unit_type':AIRCRAFT,'origin_max_health':300,      'origin_max_speed':10,'origin_shot_range':10,'origin_defense':50, 'defense_type':LIGHT,    'origin_attack':5, 'attack_type':MACHINEGUN, 'skill_cd_1':1,   'skill_cd_2':-1, 'max_account':200,'people_cost':2, 'money_cost':300, 'tech_cost':500 },
    ...
    'build_lab':     {'unit_type':BUILDING,'origin_max_health':100000000,'origin_max_speed':0, 'origin_shot_range':0, 'origin_defense':0,  'defense_type':FORT,    'origin_attack':0,  'attack_type':NULL,'skill_cd_1':-1,'skill_cd_2':75, 'max_account':0,   'people_cost':0, 'money_cost':0,   'tech_cost':0   },
    'finance_lab':   {'unit_type':BUILDING,'origin_max_health':100000000,'origin_max_speed':0, 'origin_shot_range':0, 'origin_defense':0,  'defense_type':FORT,    'origin_attack':0,  'attack_type':NULL,'skill_cd_1':-1,'skill_cd_2':50, 'max_account':0,   'people_cost':0, 'money_cost':0,   'tech_cost':0   },
    'material_lab':  {'unit_type':BUILDING,'origin_max_health':100000000,'origin_max_speed':0, 'origin_shot_range':0, 'origin_defense':0,  'defense_type':FORT,    'origin_attack':0,  'attack_type':NULL,'skill_cd_1':-1,'skill_cd_2':50, 'max_account':0,   'people_cost':0, 'money_cost':0,   'tech_cost':0   },
    'nano_lab':      {'unit_type':BUILDING,'origin_max_health':100000000,'origin_max_speed':0, 'origin_shot_range':0, 'origin_defense':0,  'defense_type':FORT,     'origin_attack':0, 'attack_type':NULL, 'skill_cd_1':-1,'skill_cd_2':2, 'max_account':0,   'people_cost':0, 'money_cost':0,   'tech_cost':0   },
